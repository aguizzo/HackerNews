...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference('Submission.count') do
      post submissions_url, params: { submission: { text: @submission.text, title: @submission.title, url: @submission.url } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { text: @submission.text, title: @submission.title, url: @submission.url } }
